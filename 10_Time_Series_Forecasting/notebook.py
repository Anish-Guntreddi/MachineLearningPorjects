...
# Load dataset
data_module = TimeSeriesDataModule(dataset_name='synthetic', data_path='./data', sequence_length=config.get('sequence_length', 24), prediction_length=config.get('prediction_length', 12), batch_size=config['batch_size'], num_workers=platform_config['num_workers'])
data_module.setup()
...
model_card = {
    ...
    'short_description': 'LSTM/Transformer time series models',
