...
# Load dataset
train_loader, val_loader, test_loader = create_data_loaders(dataset_name='synthetic', batch_size=config['batch_size'], num_workers=platform_config['num_workers'])
...
# Create model
model = get_model('transformer', src_vocab_size=config.get('src_vocab_size', 32000), tgt_vocab_size=config.get('tgt_vocab_size', 32000))
...
model_card = {
    ...
    'short_description': 'Seq2seq translation models',
    'category': 'NLP',
    'input_type': 'text',
