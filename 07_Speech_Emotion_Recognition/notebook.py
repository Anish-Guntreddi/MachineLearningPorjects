...
# Create model
model = get_model(config['model_name'], input_dim=40, num_classes=config['num_classes'])
...
model_card = {
    ...
    'short_description': 'Audio emotion classification',
    'category': 'Audio',
    'input_type': 'audio',
